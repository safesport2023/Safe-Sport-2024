...
`}</p>
                    ...
                    <div className='content-section'>
                        <h2 className='Header-hero'> {language === 'english' ? `Marissa Papaconstantinou (Track and Field)` : `Marissa Papaconstantinou (Athlétisme)`} </h2>
                    ...
                    <div className='content-section'>
                        <h2 className='Header-hero'>  {language === 'english' ? `Marie-Alex Bélanger (Vollyball)` : `Marie-Alex Bélanger (Vollyball)`} </h2>
